...
export const en: typeof ru = {
  ...
  membership: {
    ...
    sportLabel: "Sport",
    sportPlaceholder: "For example, climbing",
    sportHint: "Leave empty to train like everyone else",
    emojiLabel: "Badge",
    goalLabel: "My goal",
    goalUnit: "workouts",
    goalHint: (goal: number) => `Room default: ${goal}`,
    useRoomGoal: "Room default",
    save: "Save",
    saved: "Settings saved",
    freezeTitle: "Freeze",
    freezeLede:
    ...
    freezeTo: "To",
    freezeStart: "Freeze",
    freezeCancel: "Unfreeze",
    freezeActive: (until: string) => `Frozen until ${until}`,
    freezeScheduled: (from: string, to: string) => `Freeze from ${from} to ${to}`,
    freezeCooldown: (until: string) => `Next freeze available from ${until}`,
    freezeLimits: "1 to 30 days, no backdating",
    freezeStarted: "Freeze is on",
    freezeCanceled: "Freeze removed",
  },
  share: {
  ...
  board: {
    ...
    shameEarly: "The first period is still running",
    shameEarlyHint: "Nobody can be shamed until the first period closes with the goal missed",
    taunts: [
  ...
  checkinSheet: {
    ...
    geoAccuracy: "GPS accuracy is too low, try again at the gym entrance",
  },
  camera: {
    shoot: "Take photo",
    flip: "Flip camera",
